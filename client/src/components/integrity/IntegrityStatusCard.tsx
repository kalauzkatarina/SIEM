            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full gap-6">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="truncate">
                        ...
                        <div className={`text-lg font-bold truncate ${isSecure ? "text-green-600" : "text-red-600"
                            }`}>
                ...
                <div className="flex flex-wrap md:flex-nowrap items-center gap-6">
                    ...
                    <div className="text-center md:text-center md:border-l border-gray-300 md:pl-6">
                        <label className="block text-xs text-gray-500 uppercase tracking-wider font-semibold mb-1">
                            Last Check
                        </label>
                        <span className="ml-3! text-gray-700 font-mono text-sm font-medium">
                    ...
                    <button
                        onClick={onVerify}
                        disabled={loading}
                        className="bg-[#007a55] hover:bg-[#005c40] text-white px-5! py-2.5! rounded-lg! font-semibold flex items-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                    >
