...
export default function StatusDashboard({ statusApi }: StatusDashboardProps) {
  ...
  if (loading) {
    return (
      <div className="text-center p-10">
        ...
        <p className="text-gray-500 mt-4">Loading System Status...</p>
      </div>
    );
  }
  ...
  return (
    <div className="border-2 border-gray-300 bg-[#f5f5f5] rounded-[14px] p-3! relative">
      
      {/* Header Section */}
      <div className="flex justify-between items-center mb-[24px]!">
        <h2 className="m-0 text-gray-800">System Status & Health</h2>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6!">
        <div className="bg-gray-50 rounded-[12px] p-5! border border-gray-200">
          <div className="font-bold text-[28px]" style={{ color: operationalServices === totalServices ? "#16a34a" : "#dc2626" }}>
            {operationalServices}/{totalServices}
          </div>
          <div className="text-[12px] text-gray-500 mt-1!">Services Operational</div>
        </div>

        <div className="bg-gray-50 rounded-[12px] p-5! border border-gray-200">
          <div className="font-bold text-[28px]" style={{ color: activeIncidents > 0 ? "#dc2626" : "#16a34a" }}>
            {activeIncidents}
          </div>
          <div className="text-[12px] text-gray-500 mt-1!">Active Incidents</div>
        </div>

        <div className="bg-gray-50 rounded-[12px] p-5! border border-gray-200">
          <div className="font-bold text-[20px] mt-3!" style={{ color: "#16a34a" }}>
            {uptimePercentage.toFixed(2)}%
          </div>
          <div className="text-[12px] text-gray-500 mt-1!">Overall Uptime</div>
        </div>
      </div>
