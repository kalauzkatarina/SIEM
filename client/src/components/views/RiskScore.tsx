...
export default function RiskScore({ riskScoreApi, queryApi }: RiskScoreProps) {
    ...
    return (
        <div className="bg-[#f5f5f5] border-2 border-solid rounded-[14px] border-gray-300">
            ...
            <div className="flex gap-2 flex-shrink-0 m-[10px]! justify-end items-center">
                <div className="flex flex-col gap-[4px]">
                    <label className="px-1! block text-[11px] text-gray-600 mb-1 uppercase tracking-wider font-semibold">Entity Type</label>
                ...
                <div className="flex flex-col gap-[4px]">
                    <label className="px-1! block text-[11px] text-gray-600 mb-1 uppercase tracking-wider font-semibold">Entity Value</label>
                    <GraphParametersSelect
                        value={entityId}
                ...
                <div className="flex flex-col gap-[4px]">
                    <label className="px-1! block text-[11px] text-gray-600 mb-1 uppercase tracking-wider font-semibold">Period</label>
                    <GraphParametersSelect
                        value={period}
                ...
                <div className="flex flex-col gap-[4px]">
                    ...
                    <button
                        ...
                        className="px-4! py-2! rounded-[10px]! bg-[#007a55] hover:bg-[#00694a]! text-white transition-all duration-200"
            ...
            <div className="p-6 p-[10px]!">
                <div className="grid grid-cols-10 gap-5" ref={printRef}>
                    <div className="col-span-3 flex flex-col gap-5">
                        {/* GLOBAL SCORE */}
                        <div className="rounded-lg border-2 border-gray-300 bg-white shadow-sm p-6">
                    ...
                    {/* RISK TREND */}
                    <div className="col-span-7 flex flex-col min-h-[380px] rounded-lg border-2 border-gray-300 bg-white shadow-sm p-6">

                        {/* Header */}
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-semibold text-gray-600 m-[10px]!">
