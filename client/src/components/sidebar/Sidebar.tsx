...
export default function Sidebar({ setSideMenuPage }: SidebarProps) {
    ...
    `flex items-center justify-between text-sm cursor-pointer transition-colors p-2
   ${hover === index || selectedButton === index 
  ...
  `;
    ...
    return (
        <div
            className={`h-screen overflow-y-auto bg-[#f5f5f5] text-black transition-all duration-300 left-2 custom-sidebar ${isSidebarOpened ? "w-[200px]" : "w-[45px]"}
        `}>
            <div className="flex items-center sticky top-0 bg-[#f5f5f5] z-10 pb-2">
